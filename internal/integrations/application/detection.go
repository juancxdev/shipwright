...
func detectConfiguredBinary(probe platform.SystemProbe, platform platform.PlatformInfo, name, path, fallback string) DetectionResult {
...
func detectOpenPencilMCPCommand(probe platform.SystemProbe, platform platform.PlatformInfo, command string, configured bool, fallback string) DetectionResult {
	resolved := command
...
func detectOpenPencilMCPPath(probe platform.SystemProbe, platform platform.PlatformInfo, path string, configured bool, fallback string) DetectionResult {
	info, err := probe.Stat(path)
	if err != nil {
		return DetectionResult{
			Name:       "openpencil",
...
func openPencilMCPServerCandidates(probe platform.SystemProbe, platform platform.PlatformInfo, cfg *config.PortableConfig) []string {
...
const localSecretsFile = ".harness/secrets.local.env"
