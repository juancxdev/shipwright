...
func genericAgentsMD() string {
	...
	sb.WriteString("1. Read `.harness/project-profile.md`, `.harness/tdd-policy.md`, `.harness/skill-registry.md`, `.harness/skill-assignments.md`, and `.harness/skill-digests.md` before making technical assumptions.\n")
	...
	sb.WriteString("7. Do not mark work finished without evidence in `.harness/artifacts/reports/` when the phase requires it.\n")
	...
	sb.WriteString("- Backend must implement `.harness/artifacts/contracts/openapi.yaml`.\n")
