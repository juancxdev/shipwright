...
import (
	...
	reviewdomain "shipwright/internal/review/domain"
)

const ReviewChecklistFile = ".harness/artifacts/reports/review-checklist.md"

type FindingSeverity = reviewdomain.Severity

const (
	SeverityCritical = reviewdomain.SeverityCritical
	SeverityMedium   = reviewdomain.SeverityMedium
	SeverityLow      = reviewdomain.SeverityLow
)

type ReviewFinding = reviewdomain.Finding

type ReviewAssessment = reviewdomain.Assessment
