...
Ready for UX approval. User must run: shipwright approve ux-design`,
		...
		HandoffRules: []string{
			...
			"Provider/canvas work stays with UI/UX Designer. Hand off implementation-ready artifacts to Frontend only after UX approval.",
		},
		Never: []string{
			...
			"Delegate Stitch, OpenDesign, OpenPencil, or canvas/artifact publishing tasks to Frontend — Frontend intentionally does not have provider MCP permissions",
...
Hand off to QA/Security Reviewer. Run: shipwright next`,
		...
		HandoffRules: []string{
			...
			"If assigned a Stitch/OpenDesign/OpenPencil/provider task, stop and route back to UI/UX Designer; do not attempt provider MCP calls",
		},
		Never: []string{
			...
			"Use OpenDesign, Stitch, OpenPencil, or any design-provider MCP tools — provider work belongs to UI/UX Designer",
		},
	},
